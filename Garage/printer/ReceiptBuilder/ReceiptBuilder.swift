...
class ReceiptBuilder {
    ...
    let sfProDisplay_heavyFontAttributes_37bold = [NSAttributedString.Key.font: UIFont(name: FontsHelper.SFProDisplay.bold.rawValue, size: 37.0)!]
    let sfProDisplay_heavyFontAttributes_37boldD = [NSAttributedString.Key.font: UIFont(name: FontsHelper.SFProDisplay.bold.rawValue, size: 50.0)!]
    let sfProDisplay_heavyFontAttributes_37 = [NSAttributedString.Key.font: UIFont(name: FontsHelper.SFProDisplay.medium.rawValue, size: 37.0)!]
