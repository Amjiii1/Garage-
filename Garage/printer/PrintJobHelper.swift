...
//            
//            let companyInfo = CompanyInfo(logo: UIImage(named: "heloo.png")!, name: "The Store", phoneNumber: "0123456456", valueAddedTaxNumber: "1234567890", snapchatLink: "marnpos", instagranLink: "marnpos1")
//            return companyInfo
//        }
//        return nil
//    }
...
//    ///     - cartItems: [CartItemStruct]
//    ///     - (Bool, String) -> ()
//    func printCheckoutReceipt(printerDetails: PrinterDetailsModel, orderDetails: Orderdetail, cartItems: [CartItemStruct], completion: @escaping (Bool, String) -> ()) {
//        
